...
def test_floor_switch_request_contract() -> None:
    ...
    accepted = resolve_floor_switch_request(request, routes=[route], active_task=active, selected_map_id="map_f1")
    ...
    wrong_map = resolve_floor_switch_request(request, routes=[route], active_task=active, selected_map_id="map_f2")
