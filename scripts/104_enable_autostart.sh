...
M20PRO_FASTDDS_PROFILE=${M20PRO_FASTDDS_PROFILE:-factory}
...
M20PRO_SCAN_SOURCE=${M20PRO_SCAN_SOURCE:-local_fusion}
M20PRO_EDGE_SCAN_TOPIC=${M20PRO_EDGE_SCAN_TOPIC:-/scan}
