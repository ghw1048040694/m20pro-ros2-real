...
M20PRO_LIDAR_RELAY_MAX_OUTPUT_POINTS=${M20PRO_LIDAR_RELAY_MAX_OUTPUT_POINTS:-12000}
M20PRO_LIDAR_RELAY_MIN_PUBLISH_INTERVAL_S=${M20PRO_LIDAR_RELAY_MIN_PUBLISH_INTERVAL_S:-0.1}
M20PRO_ENABLE_LIDAR2_RELAY=${M20PRO_ENABLE_LIDAR2_RELAY:-1}
...
M20PRO_LIDAR_RELAY_FASTDDS_PROFILE=${M20PRO_LIDAR_RELAY_FASTDDS_PROFILE:-factory}
EOF
