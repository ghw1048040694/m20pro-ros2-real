...
echo "[106_enable_edge_scan_service] start manually with: systemctl start m20pro-edge-scan-106.service"
echo "[106_enable_edge_scan_service] rollback with: systemctl stop m20pro-edge-scan-106.service"
