...
def build_active_waypoint_payload(
    ...
    *,
    ...
    return {
        ...
        "last_transition_nav_goal_status": active.get("last_transition_nav_goal_status"),
        ...
        "last_floor_goal_source_floor": active.get("last_floor_goal_source_floor"),
        "last_floor_goal_target_floor": active.get("last_floor_goal_target_floor"),
        "last_floor_goal_cross_floor": active.get("last_floor_goal_cross_floor"),
